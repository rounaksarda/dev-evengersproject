...
try 
    {
          if ( empty($error) )
          {
            ...
            $mail->Username   = 'singhsabh@gmail.com';                     // SMTP username
            $mail->Password   = 'qorsrxmfumvyw';                               // SMTP password
            $mail->SMTPSecure = 'tls';                                  // Enable TLS encryption, `ssl` also accepted
            $mail->Port       = 587;                                    // TCP port to connect to
            $mail->setFrom('singhsabh@gmail.com', 'Mailer'); 
            $mail->addAddress($_SESSION['email'] ,'Rounak');     // Add a recipient
            ...
            $pdo = new PDO("mysql:host=$servername;dbname=test", $uname, $pass);
